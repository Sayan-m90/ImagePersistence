...
def do_eval(sess,
  ...
  is_label_one = tf.cast(labels_placeholder, dtype=tf.bool)
  ...
  for i in range(N):
      ...
      tp,tn,fp,fn = sess.run([true_positives,true_negatives,false_positives, false_negatives], feed_dict=feed_dict)
      #print(tp,tn,fp,fn)
      ...
      if i%10 == 0:
          print(i)
  recall,precision = cumr/float(N),cump/float(N)
  print(recall,precision)
